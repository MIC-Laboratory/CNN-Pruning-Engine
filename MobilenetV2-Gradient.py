...
def validation(network,file_name="MobilenetV2_Prune.pth",save=True,dir_name = "/weight"):
...
precentage = 0
for idx in range(11):
    # writer = SummaryWriter("MobilenetV2-data/layerwise/MobilenetV2-Gradient-Gate")
